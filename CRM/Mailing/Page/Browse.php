...
class CRM_Mailing_Page_Browse extends CRM_Core_Page {
  ...
  public function run() {
    ...
    $this->_isJourney = $this->isJourney($newArgs);
    ...
    $this->set('journey', $this->isJourney($newArgs));
  ...
  /**
   * Is the search limited to journey mailings.
   *
   * @param array $urlArguments
   *
   * @return bool
   ...
   * @throws \CRM_Core_Exception
   */
  protected function isJourney($urlArguments): bool {
    return in_array('journey', $urlArguments, TRUE) || CRM_Utils_Request::retrieveValue('is_journey', 'Boolean');
  }
}
